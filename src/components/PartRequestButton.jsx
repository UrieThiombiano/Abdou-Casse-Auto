    ...
    return (
        <>
            <button
                ...
                className="fixed left-5 z-30 btn-secondary !bg-white !px-3.5 !py-2.5 sm:!px-4 shadow-lg"
            >
                ...
                <span className="sm:hidden">Cette pièce ?</span>
                <span className="hidden sm:inline">Avez-vous cette pièce ?</span>
            </button>
