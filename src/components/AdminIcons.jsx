...
export function IconWhatsapp(props) {
    return (
        <Icon {...props}>
            ...
            <path d="M8.5 8.8c.2-.5.4-.5.7-.5h.5c.2 0 .4 0 .6.5l.7 1.6c.1.2 0 .4-.1.6l-.4.5c-.1.2-.2.3 0 .6a6 6 0 0 0 2.6 2.3c.3.1.4.1.6-.1l.5-.6c.2-.2.4-.2.6-.1l1.5.7c.3.2.4.3.4.5s0 1-.4 1.4c-.4.4-1.2.8-1.9.8-1.2 0-3-.6-4.6-2.2-1.7-1.6-2.4-3.6-2.4-4.8 0-.7.4-1.4.5-1.6Z" />
        </Icon>
    )
}
